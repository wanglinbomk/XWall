...
public class BottomTitleAdapter extends DelegateAdapter.Adapter<BaseViewHolder> {
    ...
    public BottomTitleAdapter(LayoutHelper mLayoutHelper, int mCount, int mLayoutId, Context mContext, int mViewTypeItem, List<TitleEntity> list) {
